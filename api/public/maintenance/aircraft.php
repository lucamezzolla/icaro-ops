...
json_response([
    'aircraft' => [
        ...
        'minor_repair_duration_hours' => (int)$aircraft['minor_repair_duration_hours'],
        'major_repair_duration_hours' => (int)$aircraft['major_repair_duration_hours'],
        'routine_maintenance_cost_amount' => $aircraft['routine_maintenance_cost_amount'] ?? '0.00',
        'minor_repair_cost_amount' => $aircraft['minor_repair_cost_amount'] ?? '0.00',
        'major_repair_cost_amount' => $aircraft['major_repair_cost_amount'] ?? '0.00',
    ...
    'events' => array_map(static function (array $row): array {
        return [
            ...
            'estimated_penalty_amount' => $row['estimated_penalty_amount'] ?? '0.00',
            'cost_amount' => $row['cost_amount'] ?? '0.00',
            'cost_currency_code' => $row['cost_currency_code'] ?? null,
